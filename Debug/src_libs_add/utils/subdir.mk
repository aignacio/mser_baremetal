...
OBJS += \
./src_libs_add/utils/alt_p2uart.o \
./src_libs_add/utils/alt_printf.o 

C_DEPS += \
./src_libs_add/utils/alt_p2uart.d \
./src_libs_add/utils/alt_printf.d 


# Each subdirectory must supply rules for building sources it contributes
src_libs_add/utils/alt_p2uart.o: C:/intelFPGA/17.1/embedded/ip/altera/hps/altera_hps/hwlib/src/utils/alt_p2uart.c
	@echo 'Building file: $<'
...
src_libs_add/utils/alt_printf.o: C:/intelFPGA/17.1/embedded/ip/altera/hps/altera_hps/hwlib/src/utils/alt_printf.c
	@echo 'Building file: $<'
	@echo 'Invoking: GCC C Compiler 6.2.0 [arm-altera-eabi]'
	arm-altera-eabi-gcc.exe -march=armv7-a -Dsoc_cv_av -I"C:\intelFPGA\17.1\embedded\ip\altera\hps\altera_hps\hwlib\include" -I"C:\intelFPGA\17.1\embedded\ip\altera\hps\altera_hps\hwlib" -I"C:\intelFPGA\17.1\embedded\ip\altera\hps\altera_hps\hwlib\include\soc_cv_av" -O0 -g -Wall -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o "$@" "$<"
	@echo 'Finished building: $<'
